...
def parse_args():
    ...
    parser.add_argument('--joint-dir', default=['/home/teddy/UCF-Train-Val-Test','/home/teddy/UCF-Train-Val-Test'],type=str,
                        help='joint datasets dir')
    parser.add_argument('--save-dir', default='/home/teddy/UCF-Train-Val-Test',
                        help='training data directory')
